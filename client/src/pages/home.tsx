...
import { CarTaxiFront, User, MapPin, Shield, Lock, Check, LogIn, UserPlus, ChevronDown, ChevronUp, CreditCard, UserCheck, AlertTriangle, Clock, Users, Star } from "lucide-react";
...
export default function Home() {
  ...
  // Mock ride data for home page display
  const featuredRides = [
    {
      id: 1,
      driverName: "Sarah Chen",
      driverPhoto: "https://images.unsplash.com/photo-1494790108755-2616b612b1c0?w=100&h=100&fit=crop&crop=face",
      origin: "Gainesville",
      destination: "Orlando",
      departureTime: "Dec 28, 2:00 PM",
      price: 25,
      seatsLeft: 2,
      totalSeats: 4,
    ...
    },
    {
      ...
      driverPhoto: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      origin: "Gainesville",
      destination: "Tampa",
      departureTime: "Dec 30, 4:15 PM",
      price: 35,
      seatsLeft: 3,
      totalSeats: 4,
    ...
    },
    {
      ...
      driverPhoto: "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=100&h=100&fit=crop&crop=face",
      origin: "Gainesville",
      destination: "Fort Lauderdale",
      departureTime: "Jan 3, 8:45 AM",
      price: 50,
      seatsLeft: 1,
      totalSeats: 3,
      genderPreference: "Any",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">
              See what rides are available from Gainesville to popular destinations. 
              Sign in to view all rides and book your trip with fellow Gators.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {featuredRides.map((ride) => (
              <Card key={ride.id} className="overflow-hidden border transition-shadow hover:shadow-lg" style={{ borderColor: '#D4C4A8' }}>
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-stone-900">{ride.driverName}</h3>
                      <div className="flex items-center">
                        <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 mr-1" />
                        <span className="text-sm text-stone-600">{ride.rating}</span>
                        <span className="text-sm text-stone-500 ml-2">{ride.carModel}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center mb-2">
                      <MapPin className="w-4 h-4 mr-2" style={{ color: '#B8956B' }} />
                      <span className="text-sm font-medium text-stone-900">
                        {ride.origin} → {ride.destination}
                      </span>
                    </div>
                    <div className="flex items-center">
                      <Clock className="w-4 h-4 mr-2" style={{ color: '#B8956B' }} />
                      <span className="text-sm text-stone-600">{ride.departureTime}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center">
                      <Users className="w-4 h-4 mr-1" style={{ color: '#B8956B' }} />
                      <span className="text-sm text-stone-600">
                        {ride.seatsLeft} of {ride.totalSeats} seats left
                      </span>
                    </div>
                    <Badge variant="outline" className="text-xs" style={{ borderColor: '#D4C4A8', color: '#8A6F47' }}>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold" style={{ color: '#B8956B' }}>
                      ${ride.price}
                    </span>
                    {!currentUser ? (
                      <Button 
            ...
            {!currentUser ? (
              <div className="space-y-4">
                <p className="text-stone-600">
                  Ready to start your journey with fellow Gators?
                </p>
                <Button
                  className="text-white px-8 py-3 text-lg shadow-lg"
                  style={{ backgroundColor: '#B8956B' }}
                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#A6855A'}
                  onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#B8956B'}
                  onClick={handleLogin}
                >
                  Get Started with Trek
                </Button>
              </div>
            ) : (
              <div className="space-y-4">
                <p className="text-stone-600">
                  Find more rides or post your own to help fellow Gators get around!
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    asChild
                    ...
                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#B8956B'}
                  >
                    <Link href="/find-rides">Browse All Rides</Link>
                  </Button>
                  <Button
                    asChild
                    className="text-white px-6 py-3"
                    ...
                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#9B7F56'}
                  >
                    <Link href="/post-ride">Post Your Ride</Link>
                  </Button>
                </div>
              </div>
            )}
